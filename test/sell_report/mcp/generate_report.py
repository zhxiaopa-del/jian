...
def generate_complete_report(pay_table, con_table, year, month):
    ...
    pay_dict = {}
    if pay_table_cn is not None and not pay_table_cn.empty and '公司名称' in pay_table_cn.columns:
    ...
    con_dict = {}
    if con_table_cn is not None and not con_table_cn.empty and '公司名称' in con_table_cn.columns:
